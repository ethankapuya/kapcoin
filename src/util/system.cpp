...
const char * const BITCOIN_CONF_FILENAME = "kapcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Kapcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Kapcoin";
#else
    // Unix-like
    return pathRet / ".kapcoin";
#endif
#endif
}
